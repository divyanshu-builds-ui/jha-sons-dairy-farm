        ...
        <div className="bg-gradient-to-b from-[#f8fafc] to-[#eef2ff] dark:from-[#0a0a0a] dark:to-[#000000] border-t border-royal-100/40 dark:border-[#222222] px-8 pt-8 pb-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-6 pt-4 border-t border-royal-100/30 dark:border-[#222222] flex items-center justify-between">
              ...
              <p className="text-[10px] text-gray-300 dark:text-gray-600">Designed & Developed by <a href={APP_CONFIG.developer.portfolio} target="_blank" rel="noreferrer" className="font-bold text-gray-500 dark:text-gray-400 hover:text-royal-600 transition-colors">{APP_CONFIG.developer.name}</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:hidden py-5 pb-24">
        <div className="flex flex-col items-center gap-2">
          <a href={APP_CONFIG.developer.portfolio} target="_blank" rel="noreferrer"
            ...
            Designed & Developed by <span className="font-bold text-gray-600 dark:text-gray-300">{APP_CONFIG.developer.name}</span>
          </a>
