      ...
      <div className="space-y-4">
        ...
        {productDemand.length > 0 && (
          <motion.div {...fadeUp} transition={{ delay: 0.2 }} className="lg:hidden">
            ...
            <div className="card !p-0 overflow-hidden">
              <div className="max-h-[320px] overflow-y-auto divide-y divide-warm-100 dark:divide-[#2e2d2b]">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.22 }} className="lg:hidden">
          ...
          <div className="card !p-0 overflow-hidden">
            {defaulters.length > 0 ? (
              <div className="max-h-[336px] overflow-y-auto divide-y divide-warm-100 dark:divide-[#2e2d2b]">
                {defaulters.map((d, i) => (
                  <div key={i} className="px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 shrink-0 ml-2">
                      ...
                      <a href={`https://wa.me/91${d.phone}?text=${encodeURIComponent(`Hi ${d.name}, your pending balance at Lucy Garden is Rs.${d.balance.toLocaleString()}. Kindly clear at earliest. Thank you!`)}`}
                        ...
                        className="w-7 h-7 bg-white rounded-lg flex items-center justify-center hover:bg-green-50 shrink-0 border border-[#25D366]">
      ...
      <div className="hidden lg:flex flex-col gap-4 sticky top-[57px]">
        ...
        {productDemand.length > 0 && (
          <motion.div {...fadeUp} transition={{ delay: 0.1 }}>
            ...
            <div className="card !p-0 overflow-hidden">
              <div className="divide-y divide-warm-100 dark:divide-[#2e2d2b] max-h-[300px] overflow-y-auto">
                {productDemand.map((p, i) => (
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.15 }}>
          ...
          <div className="card !p-0 overflow-hidden">
            {defaulters.length > 0 ? (
              <div className="max-h-[260px] overflow-y-auto divide-y divide-warm-100 dark:divide-[#2e2d2b]">
                {defaulters.map((d, i) => (
                  <div key={i} className="px-4 py-2.5 flex items-center justify-between hover:bg-warm-50 dark:hover:bg-[#222] transition-colors">
